...
public class Parser{
    ...
    **/ 
    ...
    /**
        ...
        <funDefinition>::= def <variable> <lparen> [<varDefList>] <rparen> [<varDefList>] [<statementList>] enddef
    **/
    ...
    **/
    ...
    /**
        Function recognizeVariableConstant: verifies for variables and constants
    **/
    public void recognizeVariableConstant(){
        try{
            int number = Integer.parseInt(lexer.getCurrentToken().text);
